...
import { Question, AdaptiveNode, DashboardStats, LearnerProfile, ContentItem, CompetencyFramework, CompetencyMapping, AIConfig, ChatSessionLog, KnowledgeBaseItem } from '../types';
